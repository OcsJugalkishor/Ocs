package com.dharmshala.marulohar.core.users.add;
...
import com.dharmshala.marulohar.utils.Constants;
import com.dharmshala.marulohar.utils.SharedPrefUtil;
...
public class AddUserInteractor implements AddUserContract.Interactor {
    ...
    public void addUserToDatabase(final Context context, FirebaseUser firebaseUser) {
        ...
        newUser user = new newUser(firebaseUser.getUid(),
